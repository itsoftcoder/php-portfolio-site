                            ...
                            <div class="col-md-12 text-white">
                                    ...
                                    <div class="text-white">
                                        <div class="card-header text-white clearfix" style="background: #112236">
                                          ...
                                          $trash_sql   = "SELECT * FROM projects WHERE deleted='1' ORDER BY id DESC";
                                          $trash_query = mysqli_query($connect,$trash_sql);
                                          $trash_count = mysqli_num_rows($trash_query);
                                           ?>
                                          <b class="float-left">projects list below here</b><a href="project-trash-list.php" class="btn btn-success float-right"><span class="badge badge-danger badge-pill float-right"><?= $trash_count; ?></span><span> project Trash</span></a>
                                        </div>
                                                 ...
                                                 <tr id="table_tr" class="<?= $row['status']==0 ? 'bg-secondary':'';?>" >
                                                    ...
                                                    <td>
                                                        <?php
                                                         ...
                                                         <?php }else { ?>
                                                           <a href="project-active.php?id=<?= $row['id']?>" class="btn text-white" title="deactive"><i class="fas fa-toggle-off" style="font-size: 28px;"></i></a>
                                                         <?php  } 
                                                        ?>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <?php if ($_SESSION['user_role'] == 2 || $_SESSION['user_role'] == 1 || $_SESSION['user_role'] == 3) { ?>
                                                                ...
                                                                <a href="project-view.php?id=<?php echo $row['id'];?>" class="btn text-purple"><i class="fa fa-eye"></i>
                                                                </a>
                                                            <?php } ?>

                                                            <?php if ($_SESSION['user_role'] == 2 || $_SESSION['user_role'] == 1) { ?>

                                                                <a href="project-edit.php?id=<?php echo $row['id'];?>" class="btn text-info"><i class="fa fa-edit"></i>
                                                                </a>

                                                            <?php } ?>

                                                            <?php if ($_SESSION['user_role'] == 1) { ?>
                                                               <a href="project-trash.php?id=<?php echo $row['id'];?>" class="btn text-warning" onclick="return confirm('are your sure move to trash this project ?')">Trash
                                                                </a>
