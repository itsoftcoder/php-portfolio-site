...
<?php 
  ...
  $sql   = "SELECT * FROM guests WHERE deleted='1' ORDER BY id DESC";
                            ...
                            <div class="col-md-12 text-white">
                                    ...
                                    <div class="text-white">
                                        <div class="card-header text-white clearfix" style="background: #112236">
                                            ...
                                            <?php 
                                              $trash_sql   = "SELECT * FROM guests WHERE deleted='0'";
                                              $trash_query = mysqli_query($connect,$trash_sql);
                                              $trash_count = mysqli_num_rows($trash_query);
                                             ?>
                                            <a href="guest-list.php" class="btn btn-success float-right"><span class="badge badge-danger badge-pill float-right"><?= $trash_count; ?></span> <span>  Guests List  </span>
                                            </a>
                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="">
                                                            ...
                                                            <?php if ($_SESSION['user_role'] == 1) { ?>
                                                                <a href="guest-restore.php?id=<?php echo $row['id'];?>" class="btn text-warning" onclick="return confirm('are your sure move to trash this guest ?')">Restore
                                                                </a>
