...
<?php 
  ...
  $sql   = "SELECT * FROM banner_icons WHERE deleted='0' ORDER BY id DESC";
                            ...
                            <div class="col-md-12 text-white">
                                    ...
                                    <div class="text-white">
                                        <div class="card-header text-white clearfix" style="background: #112236">
                                          ...
                                          $trash_sql   = "SELECT * FROM banner_icons WHERE deleted='1' ORDER BY id DESC";
                                          $trash_query = mysqli_query($connect,$trash_sql);
                                          $trash_count = mysqli_num_rows($trash_query);

                                          ?>
                                           
                                          <b class="float-left">banner icons list below here</b><a href="banner-icons-trash-list.php" class="btn btn-success float-right"><span class="badge badge-danger badge-pill float-right"><?= $trash_count;?></span><span> Banner icons Trash </span></a>
                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <?php if ($_SESSION['user_role'] == 1) { ?>
                                                               <a href="banner-icons-trash.php?id=<?php echo $row['id'];?>" class="btn text-warning" onclick="return confirm('are your sure move to trash this banner icon ?')">Trash
                                                                </a>
