...
<?php 
  ...
  $sql   = "SELECT * FROM photos WHERE deleted='1' ORDER BY id DESC";
                            ...
                            <div class="col-md-12 text-white">
                                    ...
                                    <div class="text-white">
                                        <div class="card-header text-white clearfix" style="background: #112236">
                                            ...
                                            <?php 
                                              $trash_sql   = "SELECT * FROM photos WHERE deleted='0'";
                                              $trash_query = mysqli_query($connect,$trash_sql);
                                              $trash_count = mysqli_num_rows($trash_query);
                                             ?>
                                            <a href="photo-list.php" class="btn btn-success float-right"><span class="badge badge-danger badge-pill float-right"><?= $trash_count; ?></span> <span>  photos list </span>
                                            </a>
                                        </div>
                                                ...
                                                <?php
                                                 ...
                                                 <tr id="table_tr">
                                                    ...
                                                    <td class="<?php $row['status'] == 0 ? 'bg-secondary':''; ?>">
                                                      <?php if ($row['status'] == 0){ ?>
                                                        <a href="photo-active.php?id=<?=$row['id'];?>" class="text-secondary"><i class="fas fa-toggle-off" style="font-size: 28px;"></i></a>
                                                      <?php }else{ ?>
                                                    ...
                                                    <td>
                                                        <div class="">
                                                            ...
                                                            <?php if ($_SESSION['user_role'] == 1) { ?>
                                                                <a href="photo-restore.php?id=<?php echo $row['id'];?>" class="btn text-warning" onclick="return confirm('are your sure Restore this photo ?')">Restore
                                                                </a>
